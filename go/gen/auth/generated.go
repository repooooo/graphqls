...
func (ec *executionContext) unmarshalNLoginRequest2githubᚗcomᚋrepoooooᚋgraphqlsᚋgoᚋgenᚋauthᚋmodelᚐLoginRequest(ctx context.Context, v interface{}) (model.LoginRequest, error) {
	res, err := ec.unmarshalInputLoginRequest(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNLoginResponse2githubᚗcomᚋrepoooooᚋgraphqlsᚋgoᚋgenᚋauthᚋmodelᚐLoginResponse(ctx context.Context, sel ast.SelectionSet, v model.LoginResponse) graphql.Marshaler {
	return ec._LoginResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNLoginResponse2ᚖgithubᚗcomᚋrepoooooᚋgraphqlsᚋgoᚋgenᚋauthᚋmodelᚐLoginResponse(ctx context.Context, sel ast.SelectionSet, v *model.LoginResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNLogoutRequest2githubᚗcomᚋrepoooooᚋgraphqlsᚋgoᚋgenᚋauthᚋmodelᚐLogoutRequest(ctx context.Context, v interface{}) (model.LogoutRequest, error) {
	res, err := ec.unmarshalInputLogoutRequest(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNLogoutResponse2githubᚗcomᚋrepoooooᚋgraphqlsᚋgoᚋgenᚋauthᚋmodelᚐLogoutResponse(ctx context.Context, sel ast.SelectionSet, v model.LogoutResponse) graphql.Marshaler {
	return ec._LogoutResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNLogoutResponse2ᚖgithubᚗcomᚋrepoooooᚋgraphqlsᚋgoᚋgenᚋauthᚋmodelᚐLogoutResponse(ctx context.Context, sel ast.SelectionSet, v *model.LogoutResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
